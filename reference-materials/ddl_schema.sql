...
\restrict ABVe6lYL9AgZtiLibuTtS0nMcGLzleJyEjbif56cTIIdHdQICRN67wmmboNELGM
...
CREATE TABLE efrm.adverse_integration_config (
    ...
    CONSTRAINT adverse_integration_config_active_chk CHECK (((is_active)::text = ANY (ARRAY[('Y'::character varying)::text, ('N'::character varying)::text]))),
    CONSTRAINT adverse_integration_config_auth_chk CHECK (((auth_type)::text = ANY (ARRAY[('NONE'::character varying)::text, ('API_KEY'::character varying)::text, ('BEARER_TOKEN'::character varying)::text]))),
    CONSTRAINT adverse_integration_config_enabled_chk CHECK (((is_chaining_enabled)::text = ANY (ARRAY[('Y'::character varying)::text, ('N'::character varying)::text]))),
    CONSTRAINT adverse_integration_config_llm_provider_chk CHECK (((llm_provider)::text = ANY (ARRAY[('local'::character varying)::text, ('bedrock'::character varying)::text, ('groq'::character varying)::text, ('gemini'::character varying)::text]))),
    CONSTRAINT adverse_integration_config_method_chk CHECK (((http_method)::text = 'POST'::text)),
    CONSTRAINT adverse_integration_config_search_provider_chk CHECK (((search_provider)::text = ANY (ARRAY[('tavily'::character varying)::text, ('brave'::character varying)::text, ('gdelt'::character varying)::text])))
);
...
CREATE TABLE efrm.capability_endpoint_map (
    ...
    CONSTRAINT chk_cemap_method CHECK (((http_method)::text = ANY (ARRAY[('GET'::character varying)::text, ('HEAD'::character varying)::text, ('POST'::character varying)::text, ('PUT'::character varying)::text, ('PATCH'::character varying)::text, ('DELETE'::character varying)::text]))),
    CONSTRAINT chk_cemap_service CHECK (((service_code)::text = ANY (ARRAY[('ADMIN'::character varying)::text, ('RULE_ENGINE'::character varying)::text, ('SCREENING'::character varying)::text, ('AMC'::character varying)::text, ('ML_ENGINE'::character varying)::text]))),
    CONSTRAINT chk_cemap_status CHECK (((status)::text = ANY (ARRAY[('ACTIVE'::character varying)::text, ('INACTIVE'::character varying)::text])))
);
...
CREATE TABLE efrm.case_decision_master (
    ...
    CONSTRAINT chk_case_decision_updates_customer_risk CHECK (((updates_customer_risk)::text = ANY (ARRAY[('Y'::character varying)::text, ('N'::character varying)::text])))
);
...
CREATE TABLE efrm.efrm_service_config (
    ...
    CONSTRAINT efrm_service_config_mode_check CHECK (((mode)::text = ANY (ARRAY[('SYNC'::character varying)::text, ('ASYNC'::character varying)::text, ('BOTH'::character varying)::text])))
);
...
CREATE TABLE efrm.security_capability (
    ...
    created_at timestamp with time zone NOT NULL,
    modified_at timestamp with time zone NOT NULL,
    CONSTRAINT chk_scap_action CHECK (((action_code)::text = ANY (ARRAY[('VIEW'::character varying)::text, ('CREATE'::character varying)::text, ('UPDATE'::character varying)::text, ('DELETE'::character varying)::text, ('EXECUTE'::character varying)::text, ('APPROVE'::character varying)::text, ('REJECT'::character varying)::text, ('DECIDE'::character varying)::text, ('ASSIGN'::character varying)::text, ('CLOSE'::character varying)::text, ('UPLOAD'::character varying)::text, ('EXPORT'::character varying)::text, ('CONFIGURE'::character varying)::text, ('MANAGE'::character varying)::text]))),
    CONSTRAINT chk_scap_risk CHECK (((risk_level)::text = ANY (ARRAY[('LOW'::character varying)::text, ('MEDIUM'::character varying)::text, ('HIGH'::character varying)::text, ('CRITICAL'::character varying)::text]))),
    CONSTRAINT chk_scap_status CHECK (((status)::text = ANY (ARRAY[('ACTIVE'::character varying)::text, ('INACTIVE'::character varying)::text])))
);
...
CREATE TABLE efrm.user_session (
    ...
    CONSTRAINT chk_usess_scope CHECK (((session_scope)::text = ANY (ARRAY[('FULL'::character varying)::text, ('PASSWORD_CHANGE'::character varying)::text]))),
    CONSTRAINT chk_usess_status CHECK (((status)::text = ANY (ARRAY[('ACTIVE'::character varying)::text, ('EXPIRED'::character varying)::text, ('LOGGED_OUT'::character varying)::text, ('REVOKED'::character varying)::text])))
);
...
ALTER TABLE ONLY efrm.alert_category_master
    ADD CONSTRAINT alert_category_master_unique UNIQUE (config_master_id, category_code);
...
ALTER TABLE ONLY efrm.alert_count_boost_config
    ADD CONSTRAINT alert_count_boost_config_unique UNIQUE (config_master_id, min_alert_count, max_alert_count);
...
ALTER TABLE ONLY efrm.case_priority_master
    ADD CONSTRAINT case_priority_master_unique UNIQUE (config_master_id, priority_code);
...
ALTER TABLE ONLY efrm.category_correlation_config
    ADD CONSTRAINT category_correlation_config_unique UNIQUE (config_master_id, category_count);
...
ALTER TABLE ONLY efrm.critical_override_rules
    ADD CONSTRAINT critical_override_rules_unique UNIQUE (config_master_id, rule_code);
...
--
-- Name: ml_model_job ml_model_job_unique; Type: CONSTRAINT; Schema: efrm; Owner: -
--

ALTER TABLE ONLY efrm.ml_model_job
    ADD CONSTRAINT ml_model_job_unique UNIQUE (model_version_id, job_type);
...
--
-- Name: adverse_alert adverse_alert_result_id_fkey; Type: FK CONSTRAINT; Schema: efrm; Owner: -
--

ALTER TABLE ONLY efrm.adverse_alert
    ADD CONSTRAINT adverse_alert_result_id_fkey FOREIGN KEY (result_id) REFERENCES efrm.adverse_result(id) ON DELETE CASCADE;
...
--
-- Name: screening_alert screening_alert_result_id_fkey; Type: FK CONSTRAINT; Schema: efrm; Owner: -
--

ALTER TABLE ONLY efrm.screening_alert
    ADD CONSTRAINT screening_alert_result_id_fkey FOREIGN KEY (result_id) REFERENCES efrm.screening_result(id);
...
\unrestrict ABVe6lYL9AgZtiLibuTtS0nMcGLzleJyEjbif56cTIIdHdQICRN67wmmboNELGM
